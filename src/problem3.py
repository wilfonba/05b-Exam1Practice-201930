...
def run_test_problem3a():
    ...
    # window 4:
    title = 'Problem 3a. Test 5: Start at (25,50), 11 lines'
    window4 = rg.RoseWindow(450, 300, title)

    # test 5 on window 4
    point = rg.Point(25,50)
    expected = 153
...
def problem3a(window, point, n):
    ...
    for k in range(n-1):
        k = k + 1
        p1 = rg.Point(p1.x + 20, p1.y + 10)
        p2 = rg.Point(p2.x + 20, p2.y + 10)
        line = rg.Line(p1,p2)
...
def problem3b(m, point1):
    ...
    # -------------------------------------------------------------------------
    window = rg.RoseWindow(450,650)

    total1 = 0
    for k in range(m):
        total = problem3a(window, point1, 2*(k+1) + 1)
        total1 = total1 + total
